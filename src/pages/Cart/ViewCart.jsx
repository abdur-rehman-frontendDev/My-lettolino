        ...
        <div className="container py-5 position-relative">
            ...
            <div className='row'>
                                            ...
                                            {cartItems.map((item, index) => (
                                                <div className="cart-item py-4 border-bottom" key={item.id}>
                                                    <div className="row">
                                                        ...
                                                        <div className="cart-item__totals col-12 col-sm-3 text-center text-sm-end">
                                                            <div className="row pt-4 pt-sm-0">
                ...
                <div className="col-12 col-lg-4">
                    <div className="p-3 p-lg-4" style={{ backgroundColor: '#f8f8f8' }}>
